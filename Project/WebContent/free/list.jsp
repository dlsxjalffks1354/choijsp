...
<body>
	...
	<table width="500" cellpadding="0" cellspacing="0"border="1" class="table">
		...
		<c:otherwise>
			<li class="page-item"><a class="page-link" href="list.bbs?page=1">처음</a></li>
		</c:otherwise>
		</c:choose>
		<!-- 이전 -->
		<c:choose>
		...
		<c:otherwise>
			<li class="page-item"><a class="page-link" href="list.bbs?page=${page.curPage-1}">이전</a>
		</c:otherwise>
		</c:choose>
		...
		<c:otherwise>
		<li class="page-item">
		<a class="page-link" href="list.bbs?page=${fEach}">${fEach}</a>&nbsp;
		</c:otherwise>
		</c:choose>		
		</c:forEach>
		...
		<c:otherwise>
		<li class="page-item">
		<a class="page-link" href="list.bbs?page=${page.curPage + 1}">다음</a>
		</c:otherwise>
		</c:choose>
		<!-- 끝 -->
		<c:choose>
