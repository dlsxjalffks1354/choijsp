...
<body>
	...
	<table width="500" cellpadding="0" cellspacing="0"border="1" style="margin-left: auto; margin-right: auto;">
		...
		<tr>
			<td> 글쓴이 </td>
			<td> 
			 <input type="text" readonly class="form-control-plaintext" name="nName" id="staticEmail"  value="<%=dto.getNickname() %>">
			</td>
		</tr>
		<tr>
			<td> 글 제목 </td>
		...
		<tr>
			<td> 내용 </td>
			<td> <textarea name="nContent" id="summernote" rows="10" cols="100"></textarea>
			<script>
		 ...
		 <input type="hidden" name="nUser" id="nUser" value="<%=dto.getId() %>">
		<tr>
			<td colspan="2">
