...
<body>
	...
	<table width="500" cellpadding="0" cellspacing="0"border="1" class="table">
		...
		<c:otherwise>
		<li class="page-item">
		<a class="page-link" href="search.nc?page=${fEach}&searchoption=<%= searchoption %>&search=<%= search %>">${fEach}</a>&nbsp;
		</c:otherwise>
		</c:choose>		
		</c:forEach>
		...
		<c:otherwise>
		<li class="page-item">
		<a class="page-link" href="search.nc?page=${page.curPage + 1}&searchoption=<%= searchoption %>&search=<%= search %>">다음</a>
		</c:otherwise>
		</c:choose>
		<!-- 끝 -->
		<c:choose>
		...
		<c:otherwise>
			<li class="page-item"><a class="page-link" href="search.nc?page=${page.totalPage}&searchoption=<%= searchoption %>&search=<%= search %>">끝</a>
		</c:otherwise>
		</c:choose>
		</ul>
		</nav>
