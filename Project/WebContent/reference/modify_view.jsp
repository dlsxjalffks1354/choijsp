    ...
    <header class="masthead" style="background-image: url('../img/img2.jpg')">
      ...
      <div class="container">
		...
		<table width="500" cellpadding="0" cellspacing="0"border="1" style="margin-left: auto; margin-right: auto;">
			<form action = "modify.rf" method="post">
				...
				<tr>
					<td>첨부 파일</td>
					<td>
					<a href ='download.rf?fileName=${content_view.fileName}'>${content_view.fileName}
					</a>
					</td>
				</tr>
				<tr>
					<td colspan="2"> <input type="submit" value="수정"> &nbsp;&nbsp;
						<a href="content_view.rf?bId=${content_view.bId}">취소</a>&nbsp;&nbsp;
