    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
         ...
         <form name="memInfo" method="post" onsubmit="return formCheck();">
			         		...
			         		<tr>
			         			...
			         			<td>
			         				<input type="tel" class="form-control" placeholder="PhoneNumber"
				                			name="phone" value="${dto.phonenumber }" readonly />
			         			</td>
			         		</tr>
			         		<tr>
            ...
            <div class="form-group">
              <button type="button" class="btn btn-primary"
              	onclick="location.href='<c:url value="/Source/MemberModify?id=${sessionScope.USER_ID }"/>'">Modify</button>
              <button type="button" class="btn btn-danger"
              	onclick="location.href='<c:url value="/Source/MemberDelete.jsp?id=${sessionScope.USER_ID }"/>'">Delete</button>
            </div>
          </form>
